...
Facts for african-elephant Junior Ranger + Park Ranger (easy + hard)
...
counts (tens of thousands, no single 40k–60k lock). Reserve bush vs
forest / Loxodonta for Zoologist. Park Ranger vs-Asian is ear size /
back shape only.
...
# African elephant ships Junior Ranger + Park Ranger.
