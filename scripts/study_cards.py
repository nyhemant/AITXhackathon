...
reef care, not-just-Nemo myth). Zoologist is reserved
for later. Do not invent photos.
...
TALK_ABOUT_CLOWNFISH = (
    "Clownfish are born male; the biggest can become female if she is gone. Why might that ladder matter?",
    "False percula and true orange clownfish can look alike. What might you notice in the black outline?",
    "Special mucus plus careful touching of tentacles helps them settle. Why isn’t protection instant?",
)
PUSH_FURTHER_CLOWNFISH = (
    "The biggest fish is the breeding female; smaller fish wait in line. Why might that size order matter?",
    "The fish gets shelter; the anemone may get cleaning or defense help. How might both sides gain?",
    "Captive-bred clownfish are popular pets. Why might that take pressure off wild reefs?",
)
