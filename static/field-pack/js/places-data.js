...
window.FP_PLACES = [
  ...
  // —— International (shown only on International map scope) ——
  {
    id: "london-zoo",
    name: "London Zoo",
    city: "London",
  ...
  },
  {
    ...
    status: "soon",
    tier: "intl",
    blurb: "Hillside zoo with pandas — kit on the way.",
    lat: 55.9426,
    lon: -3.2692,
  ...
  },
  {
    ...
    status: "soon",
    tier: "intl",
    blurb: "Pacific-ring tanks — hunt pack soon.",
    lat: 34.6545,
    lon: 135.4289,
...
window.FP_INTL_PLACE_IDS = ["london-zoo", "nhm-london", "paris-zoo", "berlin-zoo", "artis-zoo", "dublin-zoo", "edinburgh-zoo", "toronto-zoo", "vancouver-aquarium", "chapultepec-zoo", "singapore-zoo", "singapore-night-safari", "taronga-zoo", "melbourne-zoo", "ueno-zoo", "osaka-aquarium"];
