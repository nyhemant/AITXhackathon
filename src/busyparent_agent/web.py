        ...
        <div class="tab-panel" id="active-panel" role="tabpanel" aria-labelledby="dinner-tab">
          ...
          <form id="form">
            ...
            <div class="input-copy">
              ...
              <p class="input-helper" id="inputHelper">Use prompts or tell me: 2–4 things on hand, mood to cook, fast or flexible, picky-kid no-gos, etc.</p>
            </div>
    ...
    <script>
      ...
      const inputCopyByState = {
        start: {
          ...
          helper: "Use prompts or tell me: 2–4 things on hand, mood to cook, fast or flexible, picky-kid no-gos, etc.",
