...
class OctopusZoologistStudyCardTests(unittest.TestCase):
    def test_zoologist_deck_is_answer_light(self):
        ...
        self.assertEqual(deck["talk_about"], visible_prompts(TALK_ABOUT_OCTOPUS_ZOOLOGIST, deck["level"]))
        self.assertEqual(deck["push_further"], visible_prompts(PUSH_FURTHER_OCTOPUS_ZOOLOGIST, deck["level"]))
    ...
    def test_zoologist_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_OCTOPUS_ZOOLOGIST, "zoologist") + visible_prompts(PUSH_FURTHER_OCTOPUS_ZOOLOGIST, "zoologist"):
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        print_tpl = study_print_html_for("octopus")
