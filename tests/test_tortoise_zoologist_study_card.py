...
class TortoiseZoologistStudyCardTests(unittest.TestCase):
    ...
    def test_zoologist_slots_and_copy_are_locked(self):
        ...
        self.assertIn("Chelonoidis", correct_choice_text(questions[0]))
        self.assertIn("Geochelone", correct_choice_text(questions[0]))
        self.assertIn("Testudo", correct_choice_text(questions[0]))
        self.assertIn("species complex", correct_choice_text(questions[1]).lower())
        self.assertIn("dozen-plus", correct_choice_text(questions[1]).lower())
        self.assertIn("debated", correct_choice_text(questions[1]).lower())
        self.assertIn("adaptive radiation", correct_choice_text(questions[2]).lower())
        self.assertIn("divergent shell", correct_choice_text(questions[2]).lower())
        self.assertIn("ectothermy", correct_choice_text(questions[3]).lower())
        self.assertIn("low metabolic", correct_choice_text(questions[3]).lower())
        self.assertIn("fused ribs", correct_choice_text(questions[4]).lower())
        self.assertIn("vertebrae", correct_choice_text(questions[4]).lower())
        self.assertIn("keratin scutes", correct_choice_text(questions[4]).lower())
        self.assertIn("C. abingdonii", correct_choice_text(questions[5]))
        self.assertIn("functionally extinct", correct_choice_text(questions[5]).lower())
        self.assertIn("2012", correct_choice_text(questions[5]))
        self.assertIn("living female", correct_choice_text(questions[6]).lower())
        self.assertIn("presumed extinct", correct_choice_text(questions[6]).lower())
        self.assertIn("megaherbivore", correct_choice_text(questions[7]).lower())
        self.assertIn("ecosystem engineer", correct_choice_text(questions[7]).lower())
        self.assertIn("seed", correct_choice_text(questions[7]).lower())
        self.assertIn("DNA-repair", correct_choice_text(questions[8]))
        self.assertIn("immune", correct_choice_text(questions[8]).lower())
        self.assertIn("tumour-suppression", correct_choice_text(questions[8]).lower())
        self.assertIn("incubation temperature", correct_choice_text(questions[9]).lower())
        self.assertIn("not sex chromosomes", correct_choice_text(questions[9]).lower())
