...
class ElephantEasyStudyCardTests(unittest.TestCase):
    ...
    def test_generator_html_is_study_not_worksheet(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_ELEPHANT, "easy") + visible_prompts(PUSH_FURTHER_ELEPHANT, "easy"):
        ...
        self.assertIn("Facts from Wikipedia, African elephant / Elephant. Where sources disagree on exact numbers, we keep them approximate.", html)
