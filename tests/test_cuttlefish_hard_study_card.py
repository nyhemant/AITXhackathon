...
class CuttlefishHardStudyCardTests(unittest.TestCase):
    def test_hard_deck_is_park_ranger_without_teach(self):
        ...
        self.assertEqual(deck["talk_about"], visible_prompts(TALK_ABOUT_CUTTLEFISH, deck["level"]))
        self.assertEqual(deck["push_further"], visible_prompts(PUSH_FURTHER_CUTTLEFISH, deck["level"]))
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_CUTTLEFISH, "hard") + visible_prompts(PUSH_FURTHER_CUTTLEFISH, "hard"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(crab_hard["talk_about"], visible_prompts(TALK_ABOUT_CRAB, crab_hard["level"]))
        self.assertEqual(crab_hard["push_further"], visible_prompts(PUSH_FURTHER_CRAB, crab_hard["level"]))
        ...
        self.assertEqual(clown_hard["talk_about"], visible_prompts(TALK_ABOUT_CLOWNFISH, clown_hard["level"]))
        self.assertEqual(clown_hard["push_further"], visible_prompts(PUSH_FURTHER_CLOWNFISH, clown_hard["level"]))
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        print_tpl = study_print_html_for("cuttlefish")
