...
class ElephantHardStudyCardTests(unittest.TestCase):
    def test_hard_deck_is_park_ranger_without_teach(self):
        self.assertEqual(shipped_levels_for("african-elephant"), ("easy", "hard"))
    ...
    def test_hard_slots_and_copy_are_locked(self):
        ...
        self.assertIn("Tens of thousands", questions[0]["choices"][1])
        self.assertIn("no bone", questions[0]["choices"][1])
        self.assertIn("low-frequency rumbles", questions[1]["choices"][1])
        self.assertIn("too low for humans", questions[1]["choices"][1])
        self.assertIn("22 months", questions[2]["choices"][1])
        self.assertIn("longest of any land mammal", questions[2]["choices"][1])
        self.assertIn("memory of water and food", questions[3]["choices"][1])
        self.assertIn("conveyor", questions[4]["choices"][1])
        self.assertIn("several times", questions[4]["choices"][1])
        self.assertIn("Fatty cushion pads", questions[5]["choices"][1])
        self.assertIn("best senses of smell", questions[6]["choices"][1])
        self.assertIn("Ivory poaching", questions[7]["choices"][1])
        self.assertIn("habitat loss", questions[7]["choices"][1])
        self.assertIn("larger ears", questions[8]["choices"][1])
        self.assertIn("concave", questions[8]["choices"][1])
        self.assertIn("myth", questions[9]["choices"][1])
        self.assertIn("sudden movement", questions[9]["choices"][1])
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertNotIn("zoologist", payload["african-elephant"]["levels"])
