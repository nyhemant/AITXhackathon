...
class SharkZoologistStudyCardTests(unittest.TestCase):
    ...
    def test_zoologist_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_SHARK, "zoologist") + visible_prompts(PUSH_FURTHER_SHARK, "zoologist"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(koala_zoo["talk_about"], visible_prompts(TALK_ABOUT_KOALA, koala_zoo["level"]))
        self.assertEqual(koala_zoo["push_further"], visible_prompts(PUSH_FURTHER_KOALA, koala_zoo["level"]))
        ...
        self.assertEqual(chimp_zoo["talk_about"], visible_prompts(TALK_ABOUT_CHIMPANZEE, chimp_zoo["level"]))
        self.assertEqual(chimp_zoo["push_further"], visible_prompts(PUSH_FURTHER_CHIMPANZEE, chimp_zoo["level"]))
        ...
        self.assertEqual(orang_zoo["talk_about"], visible_prompts(TALK_ABOUT_ORANGUTAN, orang_zoo["level"]))
        self.assertEqual(orang_zoo["push_further"], visible_prompts(PUSH_FURTHER_ORANGUTAN, orang_zoo["level"]))
        ...
        self.assertEqual(giant_zoo["talk_about"], visible_prompts(TALK_ABOUT_GIANT_PANDA, giant_zoo["level"]))
        self.assertEqual(giant_zoo["push_further"], visible_prompts(PUSH_FURTHER_GIANT_PANDA, giant_zoo["level"]))
        ...
        self.assertEqual(lemur_zoo["talk_about"], visible_prompts(TALK_ABOUT_RING_TAILED_LEMUR, lemur_zoo["level"]))
        self.assertEqual(lemur_zoo["push_further"], visible_prompts(PUSH_FURTHER_RING_TAILED_LEMUR, lemur_zoo["level"]))
        ...
        self.assertEqual(ostrich_zoo["talk_about"], visible_prompts(TALK_ABOUT_OSTRICH, ostrich_zoo["level"]))
        self.assertEqual(ostrich_zoo["push_further"], visible_prompts(PUSH_FURTHER_OSTRICH, ostrich_zoo["level"]))
        ...
        self.assertEqual(hog_zoo["talk_about"], visible_prompts(TALK_ABOUT_WARTHOG, hog_zoo["level"]))
        self.assertEqual(hog_zoo["push_further"], visible_prompts(PUSH_FURTHER_WARTHOG, hog_zoo["level"]))
