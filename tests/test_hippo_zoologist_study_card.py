...
class HippoZoologistStudyCardTests(unittest.TestCase):
    ...
    def test_zoologist_slots_and_copy_are_locked(self):
        ...
        self.assertIn("Hipposudoric acids", questions[0]["choices"][1])
        self.assertIn("norhipposudoric", questions[0]["why"].lower())
        self.assertIn("ultraviolet", questions[0]["why"].lower())
        self.assertIn("cetaceans", questions[1]["choices"][1].lower())
        self.assertIn("clade", questions[1]["choices"][1].lower())
        self.assertIn("anthracothere", questions[1]["why"].lower())
        self.assertIn("tens of millions", questions[1]["why"].lower())
        self.assertIn("subspecies have been described", questions[2]["choices"][1].lower())
        self.assertIn("rarely used", questions[2]["choices"][1].lower())
        self.assertIn("mitochondrial", questions[2]["choices"][1].lower())
        self.assertIn("Colombia", questions[3]["choices"][1])
        self.assertIn("Escobar", questions[3]["choices"][1])
        self.assertIn("feral", questions[3]["choices"][1].lower())
        self.assertIn("pseudoruminant", questions[4]["choices"][1].lower())
        self.assertIn("three-chambered", questions[4]["choices"][1].lower())
        self.assertIn("does not chew cud", questions[4]["choices"][1].lower())
        self.assertIn("Vulnerable", questions[5]["choices"][1])
        self.assertIn("snapshot", questions[5]["choices"][1].lower() + questions[5]["why"].lower())
        self.assertIn("air and water", questions[6]["choices"][1].lower())
        self.assertIn("clicks", questions[6]["choices"][1].lower())
        self.assertIn("keep growing", questions[7]["choices"][1].lower())
        self.assertIn("fighting", questions[7]["choices"][1].lower())
        self.assertIn("graviportal", questions[8]["choices"][1].lower())
        self.assertIn("sink", questions[8]["choices"][1].lower())
        self.assertIn("Hippopotamus amphibius", questions[9]["choices"][1])
        self.assertIn("pygmy", questions[9]["choices"][1].lower())
