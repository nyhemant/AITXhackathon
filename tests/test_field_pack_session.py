...
class FlagshipSessionTests(unittest.TestCase):
    ...
    def test_dallas_start_here_is_dual_cta(self):
        ...
        self.assertIn("Not yet", visible)
        self.assertIn("Virtual zoo at home", visible)
        self.assertIn("/field-pack/virtual-field-trip/?tab=zoo&amp;from=dallas-zoo", visible)
        self.assertIn('id="at-home"', visible)
        self.assertNotIn('href="#at-home"', visible.split('id="at-home"', 1)[0])
    ...
    def test_san_diego_start_here_is_dual_cta(self):
        ...
        self.assertIn("Not yet", visible)
        self.assertIn("Virtual zoo at home", visible)
        self.assertIn("/field-pack/virtual-field-trip/?tab=zoo&amp;from=san-diego-zoo", visible)
    ...
    def test_flagship_cards_reuse_vft_cams_when_present(self):
        ...
        self.assertIn("/field-pack/virtual-field-trip/?tab=zoo&from=card#habitat=koala", koala.replace("&amp;", "&"))
    ...
    def test_lion_card_keeps_chip_labels_without_home_zoo_cta(self):
        ...
        self.assertIn("Not yet", dallas)
        self.assertIn("Virtual zoo at home", dallas)
