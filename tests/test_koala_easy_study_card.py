...
class KoalaEasyStudyCardTests(unittest.TestCase):
    ...
    def test_generator_html_is_study_not_worksheet(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_KOALA, "easy") + visible_prompts(PUSH_FURTHER_KOALA, "easy"):
        ...
        self.assertIn("Facts from Wikipedia, Koala. Where sources disagree on exact numbers, we keep them approximate.", html)
    ...
    def test_published_koala_card_matches_easy_deck(self):
        ...
        self.assertIn("card-watch-live", main)
        self.assertIn("#habitat=koala", main)
        self.assertIn("/field-pack/virtual-field-trip/?tab=zoo&from=card#habitat=koala", main.replace("&amp;", "&"))
        ...
        self.assertIn('aria-label="View larger photo: Koala"', main)
