...
class SeahorseZoologistStudyCardTests(unittest.TestCase):
    def test_zoologist_deck_is_answer_light(self):
        ...
        self.assertEqual(deck["talk_about"], visible_prompts(TALK_ABOUT_SEAHORSE_ZOOLOGIST, deck["level"]))
        self.assertEqual(deck["push_further"], visible_prompts(PUSH_FURTHER_SEAHORSE_ZOOLOGIST, deck["level"]))
    ...
    def test_zoologist_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_SEAHORSE_ZOOLOGIST, "zoologist") + visible_prompts(PUSH_FURTHER_SEAHORSE_ZOOLOGIST, "zoologist"):
