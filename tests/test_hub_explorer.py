...
class HubExplorerTests(unittest.TestCase):
    ...
    def test_places_card_cta_is_honest_and_primary_only(self):
        ...
        label = cta.group(1)
        self.assertIn("All 58 cards", label)
        self.assertRegex(label, r"All \d+ cards")
        self.assertIn('href="/field-pack/cards/"', self.html)
    ...
    def test_about_is_seek_out_not_a_landing(self):
        ...
        self.assertIn('id="how-it-fits"', body)
        self.assertIn("Three ways in", body)
        self.assertNotIn("How it fits together", body)
        self.assertNotIn("doors", body.lower())
        ...
        self.assertNotIn('href="/dinner"', body)
        self.assertIn("Arya", body)
        self.assertIn("Kunal", body)
        self.assertNotIn('id="for-ai-assistants"', body)
        self.assertNotIn("mermaid", body.lower())
        self.assertNotIn("cm-*", body)
