...
class TortoiseHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_slots_and_copy_are_locked(self):
        ...
        self.assertIn("Domed and saddleback", questions[0]["choices"][1])
        self.assertIn("raised front notch", questions[1]["choices"][1])
        self.assertIn("high plants", questions[1]["choices"][1])
        self.assertIn("drier islands", questions[1]["choices"][1])
        self.assertIn("many months", questions[2]["choices"][1])
        self.assertIn("about a year", questions[2]["choices"][1])
        self.assertIn("bladder", questions[3]["choices"][1])
        self.assertIn("body tissues", questions[3]["choices"][1])
        self.assertIn("Darwin", questions[4]["choices"][1])
        self.assertIn("evolution", questions[4]["choices"][1])
        self.assertIn("Sailors", questions[5]["choices"][1])
        self.assertIn("shipboard food", questions[5]["choices"][1])
        self.assertIn("Goats eat the plants", questions[6]["choices"][1])
        self.assertIn("rats and pigs", questions[6]["choices"][1])
        self.assertIn("Pinta Island", questions[7]["choices"][1])
        self.assertIn("2012", questions[7]["choices"][1])
        self.assertIn("Diego", questions[8]["choices"][1])
        self.assertIn("many young", questions[8]["choices"][1])
        self.assertIn("column-like feet", questions[9]["choices"][1])
        self.assertIn("not flippers", questions[9]["choices"][1])
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertNotIn("zoologist", payload["galapagos-tortoise"]["levels"])
