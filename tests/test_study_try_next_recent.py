...
class StudyTryNextRecentTests(unittest.TestCase):
    ...
    def test_js_helper_runtime_matches_python(self):
        ...
        self.assertIn("puffin", catalog["neighbors"])
        self.assertEqual(
        ...
        self.assertIn("crab", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["crab"]),
            ["shark", "clownfish"],
        )
        self.assertIn("cuttlefish", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["cuttlefish"]),
            ["crab", "clownfish"],
        )
        self.assertIn("eel", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["eel"]),
            ["cuttlefish", "crab"],
        )
        self.assertIn("jellyfish", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["jellyfish"]),
            ["eel", "cuttlefish"],
        )
        self.assertIn("kelp-forest", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["kelp-forest"]),
            ["jellyfish", "sea-otter"],
        )
        self.assertIn("manta-ray", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["manta-ray"]),
            ["jellyfish", "kelp-forest"],
        )
        self.assertIn("octopus", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["octopus"]),
            ["cuttlefish", "jellyfish"],
        )
        self.assertIn("sea-turtle", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["sea-turtle"]),
            ["octopus", "manta-ray"],
        )
        self.assertIn("seahorse", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["seahorse"]),
            ["octopus", "sea-turtle"],
        )
        self.assertIn("starfish", catalog["neighbors"])
        self.assertEqual(
            list(STUDY_NEIGHBORS["starfish"]),
            ["sea-turtle", "octopus"],
        )
        self.assertIn("stingray", catalog["neighbors"])
        self.assertEqual(
