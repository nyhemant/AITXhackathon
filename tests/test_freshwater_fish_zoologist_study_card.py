...
class FreshwaterFishZoologistStudyCardTests(unittest.TestCase):
    ...
    def test_zoologist_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_FRESHWATER_FISH, "zoologist") + visible_prompts(PUSH_FURTHER_FRESHWATER_FISH, "zoologist"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(sloth_zoo["talk_about"], visible_prompts(TALK_ABOUT_TWO_TOED_SLOTH, sloth_zoo["level"]))
        self.assertEqual(sloth_zoo["push_further"], visible_prompts(PUSH_FURTHER_TWO_TOED_SLOTH, sloth_zoo["level"]))
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        print_tpl = study_print_html_for("freshwater-fish")
