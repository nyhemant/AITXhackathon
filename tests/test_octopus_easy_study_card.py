...
class OctopusEasyStudyCardTests(unittest.TestCase):
    def test_deck_is_junior_ranger_only(self):
        ...
        self.assertEqual(deck["talk_about"], visible_prompts(TALK_ABOUT_OCTOPUS, deck["level"]))
        self.assertEqual(deck["push_further"], visible_prompts(PUSH_FURTHER_OCTOPUS, deck["level"]))
    ...
    def test_generator_html_is_study_not_worksheet(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_OCTOPUS, "easy") + visible_prompts(PUSH_FURTHER_OCTOPUS, "easy"):
