...
class StingrayZoologistStudyCardTests(unittest.TestCase):
    def test_zoologist_deck_is_answer_light(self):
        ...
        self.assertEqual(deck["talk_about"], visible_prompts(TALK_ABOUT_STINGRAY_ZOOLOGIST, deck["level"]))
        self.assertEqual(deck["push_further"], visible_prompts(PUSH_FURTHER_STINGRAY_ZOOLOGIST, deck["level"]))
    ...
    def test_zoologist_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_STINGRAY_ZOOLOGIST, "zoologist") + visible_prompts(PUSH_FURTHER_STINGRAY_ZOOLOGIST, "zoologist"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(octo_zoo["talk_about"], visible_prompts(TALK_ABOUT_OCTOPUS_ZOOLOGIST, octo_zoo["level"]))
        self.assertEqual(octo_zoo["push_further"], visible_prompts(PUSH_FURTHER_OCTOPUS_ZOOLOGIST, octo_zoo["level"]))
        ...
        self.assertEqual(turtle_zoo["talk_about"], visible_prompts(TALK_ABOUT_SEA_TURTLE_ZOOLOGIST, turtle_zoo["level"]))
        self.assertEqual(turtle_zoo["push_further"], visible_prompts(PUSH_FURTHER_SEA_TURTLE_ZOOLOGIST, turtle_zoo["level"]))
        ...
        self.assertEqual(horse_zoo["talk_about"], visible_prompts(TALK_ABOUT_SEAHORSE_ZOOLOGIST, horse_zoo["level"]))
        self.assertEqual(horse_zoo["push_further"], visible_prompts(PUSH_FURTHER_SEAHORSE_ZOOLOGIST, horse_zoo["level"]))
        ...
        self.assertEqual(manta_zoo["talk_about"], visible_prompts(TALK_ABOUT_MANTA_RAY_ZOOLOGIST, manta_zoo["level"]))
        self.assertEqual(manta_zoo["push_further"], visible_prompts(PUSH_FURTHER_MANTA_RAY_ZOOLOGIST, manta_zoo["level"]))
        ...
        self.assertEqual(star_zoo["talk_about"], visible_prompts(TALK_ABOUT_STARFISH_ZOOLOGIST, star_zoo["level"]))
        self.assertEqual(star_zoo["push_further"], visible_prompts(PUSH_FURTHER_STARFISH_ZOOLOGIST, star_zoo["level"]))
        ...
        self.assertEqual(jelly_zoo["talk_about"], visible_prompts(TALK_ABOUT_JELLYFISH, jelly_zoo["level"]))
        self.assertEqual(jelly_zoo["push_further"], visible_prompts(PUSH_FURTHER_JELLYFISH, jelly_zoo["level"]))
        ...
        self.assertEqual(kelp_zoo["talk_about"], visible_prompts(TALK_ABOUT_KELP_FOREST, kelp_zoo["level"]))
        self.assertEqual(kelp_zoo["push_further"], visible_prompts(PUSH_FURTHER_KELP_FOREST, kelp_zoo["level"]))
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        print_tpl = study_print_html_for("stingray")
