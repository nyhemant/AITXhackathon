"""Two-toed sloth Easy study-card: Junior Ranger teach + 10 MCQs (first deck)."""
...
class TwoToedSlothEasyStudyCardTests(unittest.TestCase):
    ...
    def test_artifacts_include_sloth_easy_only(self):
        ...
        self.assertEqual(set(sloth["levels"]), {"easy"})
