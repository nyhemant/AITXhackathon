...
class FlamingoZoologistStudyCardTests(unittest.TestCase):
    ...
    def test_zoologist_slots_and_copy_are_locked(self):
        ...
        self.assertIn("Grebes", questions[0]["choices"][1])
        self.assertIn("Mirandornithes", questions[0]["choices"][1])
        self.assertIn("herons", questions[0]["choices"][1].lower())
        self.assertIn("carotenoid", questions[1]["choices"][1].lower())
        self.assertIn("canthaxanthin", questions[1]["choices"][1].lower())
        self.assertIn("such as", questions[1]["choices"][1].lower() + questions[1]["why"].lower())
        self.assertIn("upper digestive tract", questions[2]["choices"][1].lower())
        self.assertIn("both sexes", questions[2]["choices"][1].lower())
        self.assertIn("not mammalian milk", questions[2]["choices"][1].lower())
        self.assertIn("piston", questions[3]["choices"][1].lower())
        self.assertIn("lamellae", questions[3]["choices"][1].lower())
        self.assertIn("lower mandible", questions[4]["choices"][1].lower())
        self.assertIn("upper mandible", questions[4]["choices"][1].lower())
        self.assertIn("Nasal salt glands", questions[5]["choices"][1])
        self.assertIn("concentrated salt", questions[5]["choices"][1].lower())
        self.assertIn("Gravity", questions[6]["choices"][1])
        self.assertIn("passive stay", questions[6]["choices"][1].lower())
        self.assertIn("P. ruber", questions[7]["choices"][1])
        self.assertIn("lumped", questions[7]["choices"][1].lower())
        self.assertIn("greater flamingo", questions[7]["choices"][1].lower())
        self.assertIn("relatively straight", questions[8]["choices"][1].lower())
        self.assertIn("filter-feeding", questions[8]["choices"][1].lower())
        self.assertIn("relatively secure", questions[9]["choices"][1].lower())
        self.assertIn("lower-risk", questions[9]["choices"][1].lower())
