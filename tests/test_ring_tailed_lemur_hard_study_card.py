...
class RingTailedLemurHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_RING_TAILED_LEMUR, "hard") + visible_prompts(PUSH_FURTHER_RING_TAILED_LEMUR, "hard"):
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertIn("zoologist", payload["ring-tailed-lemur"]["levels"])
        ...
        self.assertIn("#habitat=ring-tailed-lemur", html)
