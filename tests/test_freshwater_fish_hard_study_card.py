...
class FreshwaterFishHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_FRESHWATER_FISH, "hard") + visible_prompts(PUSH_FURTHER_FRESHWATER_FISH, "hard"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(sloth_hard["talk_about"], visible_prompts(TALK_ABOUT_TWO_TOED_SLOTH, sloth_hard["level"]))
        self.assertEqual(sloth_hard["push_further"], visible_prompts(PUSH_FURTHER_TWO_TOED_SLOTH, sloth_hard["level"]))
