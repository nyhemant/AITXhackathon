...
class ZebraHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_slots_and_copy_are_locked(self):
        ...
        self.assertIn("deter biting flies", questions[0]["choices"][1])
        self.assertIn("leading", questions[0]["stem"].lower() + " " + questions[0]["why"].lower())
        self.assertIn("hypothesis", questions[0]["why"].lower())
        self.assertIn("One stallion, several mares, and their young", questions[1]["choices"][1])
        self.assertIn("bachelor groups", questions[2]["choices"][1])
        self.assertIn("tall, tough grass", questions[3]["choices"][1])
        self.assertIn("hindgut fermenter", questions[4]["choices"][1])
        self.assertIn("water-dependent", questions[5]["choices"][1])
        self.assertIn("seldom wander far", questions[5]["choices"][1])
        self.assertIn("bark or snort", questions[6]["choices"][1])
        self.assertIn("Brownish", questions[7]["choices"][1])
        self.assertIn("darken", questions[7]["choices"][1])
        self.assertIn("shadow", questions[8]["choices"][1].lower())
        self.assertIn("southern", questions[8]["choices"][1].lower())
        self.assertIn("Hunting and habitat loss", questions[9]["choices"][1])
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertNotIn("zoologist", payload["zebra"]["levels"])
