...
class StartLandingTests(unittest.TestCase):
    ...
    def test_going_chapter_is_local_jpeg(self):
        ...
        self.assertIn('src="/start/going-georgia-aquarium.jpg"', chapter)
        self.assertIn("/start/going-georgia-aquarium-480.jpg 480w", chapter)
        self.assertIn("/start/going-georgia-aquarium-640.jpg 640w", chapter)
        self.assertIn('src="/start/going-san-diego-zoo.jpg"', chapter)
        ...
        self.assertFalse((START / "going-georgia-aquarium.jpg").exists())
        self.assertFalse((START / "going-georgia-aquarium-480.jpg").exists())
        self.assertFalse((START / "going-georgia-aquarium-640.jpg").exists())
        self.assertFalse((START / "going-san-diego-zoo.jpg").exists())
        self.assertFalse((START / "going-san-diego-zoo-480.jpg").exists())
        self.assertFalse((START / "going-san-diego-zoo-640.jpg").exists())
        self.assertIn(".start-chapter", self.css)
    ...
    def test_motion_is_optional_and_tappable(self):
        ...
        self.assertIn('start.js?v=13', self.html)
        self.assertIn("start.css?v=25", self.html)
