...
class StartLandingTests(unittest.TestCase):
    ...
    def test_going_chapter_is_local_jpeg(self):
        ...
        self.assertIn("Hunt page in hand. Giraffe already checked.", chapter)
        self.assertIn('class="start-chapter-still"', chapter)
        ...
        self.assertIn("Going this week", hit.group(0))
        self.assertIn("Same animal. Real place.", hit.group(0))
        self.assertIn("Hunt page in hand. Giraffe already checked.", hit.group(0))
    ...
    def test_teach_chapter_is_local_jpeg(self):
        ...
        self.assertIn('href="/field-pack/cards/"', pills[1])
        self.assertIn("Explore cards", pills[1])
    ...
    def test_page_is_hero_chapters_and_about_footer(self):
        ...
        self.assertEqual(self.html.count('class="start-chapter"'), 3)
        self.assertEqual(len(self.pills), 6)
    ...
    def test_no_intent_tiles_or_youtube(self):
        ...
        self.assertEqual(self.html.count('href="/field-pack/dallas-zoo/"'), 2)
