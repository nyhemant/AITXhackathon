...
class GorillaHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_slots_and_copy_are_locked(self):
        ...
        self.assertIn("ripe fruit", questions[0]["choices"][1])
        self.assertIn("leaves, stems, and bark", questions[0]["choices"][1])
        self.assertIn("Swamp forest", questions[1]["choices"][1])
        self.assertIn("bais", questions[1]["choices"][1])
        self.assertIn("not strongly territorial", questions[2]["choices"][1])
        self.assertIn("overlap", questions[2]["choices"][1])
        self.assertIn("years alone", questions[3]["choices"][1])
        self.assertIn("other males", questions[3]["choices"][1])
        self.assertIn("much larger", questions[4]["choices"][1])
        self.assertIn("seeds in their dung", questions[5]["choices"][1])
        self.assertIn("Bushmeat", questions[6]["choices"][1])
        self.assertIn("forest loss", questions[6]["choices"][1])
        self.assertIn("Nearly all zoo gorillas", questions[7]["choices"][1])
        self.assertIn("western lowland", questions[7]["choices"][1])
        self.assertIn("villages, roads, and farms", questions[8]["choices"][1])
        self.assertIn("few young", questions[9]["choices"][1])
        self.assertIn("dependent", questions[9]["choices"][1])
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertIn("walk or bounce", hippo_hard["questions"][0]["choices"][1])
        ...
        self.assertIn("understory cover", tiger_hard["questions"][0]["choices"][1])
