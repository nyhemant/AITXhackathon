"""Orangutan Easy study-card: Junior Ranger teach + 10 MCQs (first deck)."""
...
class OrangutanEasyStudyCardTests(unittest.TestCase):
    def test_deck_is_junior_ranger_easy_only(self):
        ...
        self.assertEqual(shipped_levels_for("orangutan"), ("easy",))
        self.assertIsNone(study_deck_for("orangutan", "hard"))
    ...
    def test_published_orangutan_card_matches_easy_deck(self):
        ...
        self.assertIn("/field-pack/virtual-zoo/?from=card#habitat=orangutan", main)
        ...
        self.assertIn('aria-label="Watch Live: Orangutan"', main)
    ...
    def test_artifacts_include_orangutan_easy_only(self):
        ...
        self.assertEqual(set(orang["levels"]), {"easy"})
        ...
        for q in easy["questions"]:
            self.assertEqual(len(q["choices"]), 3)
        self.assertNotIn("hard", orang["levels"])
    ...
    def test_display_name_map_still_covers_future_tiers(self):
        ...
        self.assertNotIn("Park Ranger", _text(_main(orang_html)))
