"""Freshwater fish Easy study-card: Junior Ranger teach + 10 MCQs (first deck)."""
...
class FreshwaterFishEasyStudyCardTests(unittest.TestCase):
    def test_deck_is_junior_ranger_only(self):
        ...
        self.assertEqual(shipped_levels_for("freshwater-fish"), ("easy",))
        self.assertIsNone(study_deck_for("freshwater-fish", "hard"))
    ...
    def test_other_animal_stays_generic_worksheet(self):
        ...
        self.assertIn("What do they eat?", clown)
        self.assertNotIn("card-study-pack", clown)
        self.assertNotIn("Where do freshwater fish live?", clown)
    ...
    def test_artifacts_include_fish_easy_only(self):
