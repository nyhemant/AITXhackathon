...
class OstrichHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_OSTRICH, "hard") + visible_prompts(PUSH_FURTHER_OSTRICH, "hard"):
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertIn("zoologist", payload["ostrich"]["levels"])
        ...
        self.assertIn("#habitat=ostrich", html)
