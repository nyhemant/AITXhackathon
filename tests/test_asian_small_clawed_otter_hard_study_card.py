...
class AsianSmallClawedOtterHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_ASIAN_SMALL_CLAWED_OTTER, "hard") + visible_prompts(PUSH_FURTHER_ASIAN_SMALL_CLAWED_OTTER, "hard"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(shark_hard["talk_about"], visible_prompts(TALK_ABOUT_SHARK, shark_hard["level"]))
        self.assertEqual(shark_hard["push_further"], visible_prompts(PUSH_FURTHER_SHARK, shark_hard["level"]))
