...
class PolarBearHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_POLAR_BEAR, "hard") + visible_prompts(PUSH_FURTHER_POLAR_BEAR, "hard"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(fish_hard["talk_about"], visible_prompts(TALK_ABOUT_FRESHWATER_FISH, fish_hard["level"]))
        self.assertEqual(fish_hard["push_further"], visible_prompts(PUSH_FURTHER_FRESHWATER_FISH, fish_hard["level"]))
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertIn("zoologist", payload["polar-bear"]["levels"])
