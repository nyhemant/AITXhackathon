...
class FlamingoEasyStudyCardTests(unittest.TestCase):
    ...
    def test_generator_html_is_study_not_worksheet(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_FLAMINGO, "easy") + visible_prompts(PUSH_FURTHER_FLAMINGO, "easy"):
        ...
        self.assertIn("Facts from Wikipedia, American flamingo / Caribbean flamingo. Where sources disagree on exact numbers, we keep them approximate.", html)
