...
class LayerALeftoversTests(unittest.TestCase):
    ...
    def test_library_only_cards_hide_watch_live(self):
        ...
        fish_html = _main((FP / "cards" / "freshwater-fish" / "index.html").read_text(encoding="utf-8"))
        self.assertNotIn("card-watch-live", fish_html)
        self.assertNotIn("Watch Live", fish_html)
        self.assertNotIn("Watch live at", fish_html)
