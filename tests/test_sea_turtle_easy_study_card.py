"""Sea-turtle Easy study-card: Junior Ranger teach + 10 MCQs (later tiers reserved)."""
...
class SeaTurtleEasyStudyCardTests(unittest.TestCase):
    def test_deck_is_junior_ranger_only(self):
        ...
        self.assertEqual(shipped_levels_for("sea-turtle"), ("easy",))
        self.assertIsNone(study_deck_for("sea-turtle", "hard"))
    ...
    def test_artifacts_include_sea_turtle_easy_only(self):
        ...
        self.assertEqual(set(turtle["levels"]), {"easy"})
        self.assertNotIn("hard", turtle["levels"])
