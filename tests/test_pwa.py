...
class PwaTests(unittest.TestCase):
    ...
    def test_manifest_is_served_with_correct_type(self):
        ...
        self.assertEqual(body["name"], "KidZooKit")
        self.assertLessEqual(len(body["short_name"]), 12)
        self.assertEqual(body["short_name"], "KidZooKit")
    ...
    def test_service_worker_is_same_origin_and_careful(self):
        ...
        self.assertIn('FTK_SHELL_CACHE = "ftk-shell-v5"', self.sw)
    ...
    def test_start_and_vft_link_manifest_and_register(self):
        ...
        for html in pages:
            ...
            self.assertIn('name="apple-mobile-web-app-title" content="KidZooKit"', html)
            self.assertIn('src="/pwa/register.js?v=1"', html)
            self.assertIn("viewport-fit=cover", html)
        self.assertIn("start.css?v=77", self.start)
        self.assertIn("/start/start.css?v=77", self.sw)
