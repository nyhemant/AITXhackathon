...
class CardsExplorerTests(unittest.TestCase):
    ...
    def test_play_door_is_first_and_teaches_print_cut_hide(self):
        ...
        self.assertIn("cards-explorer.js?v=7", self.html)
    ...
    def test_explorer_is_samples_not_a_58_card_wall(self):
        ...
        self.assertIn("Experimental <span class=\"cards-experimental-note\">Museum stops &amp; extras</span>", self.html)
        ...
        self.assertIn('hash === "cards-attractions" || hash === "cards-experimental"', explorer_js)
        self.assertNotIn("cards-parks", explorer_js)
        self.assertIn('PRIMARY_HUB_SECTION_IDS = ("wildlife", "sealife")', gen)
        self.assertIn("EXPERIMENTAL_SHELF_LABEL = \"Experimental\"", gen)
