...
class AmericanAlligatorHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_AMERICAN_ALLIGATOR, "hard") + visible_prompts(PUSH_FURTHER_AMERICAN_ALLIGATOR, "hard"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(otter_hard["talk_about"], visible_prompts(TALK_ABOUT_SEA_OTTER, otter_hard["level"]))
        self.assertEqual(otter_hard["push_further"], visible_prompts(PUSH_FURTHER_SEA_OTTER, otter_hard["level"]))
