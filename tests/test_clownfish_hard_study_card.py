...
class ClownfishHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_CLOWNFISH, "hard") + visible_prompts(PUSH_FURTHER_CLOWNFISH, "hard"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(elk_hard["talk_about"], visible_prompts(TALK_ABOUT_ELK, elk_hard["level"]))
        self.assertEqual(elk_hard["push_further"], visible_prompts(PUSH_FURTHER_ELK, elk_hard["level"]))
        ...
        self.assertEqual(puffin_hard["talk_about"], visible_prompts(TALK_ABOUT_PUFFIN, puffin_hard["level"]))
        self.assertEqual(puffin_hard["push_further"], visible_prompts(PUSH_FURTHER_PUFFIN, puffin_hard["level"]))
