...
class GorillaZoologistStudyCardTests(unittest.TestCase):
    ...
    def test_zoologist_slots_and_copy_are_locked(self):
        ...
        self.assertIn("Critically Endangered", questions[0]["choices"][1])
        self.assertIn("snapshot", questions[0]["choices"][1].lower() + questions[0]["why"].lower())
        self.assertIn("hunting", questions[0]["choices"][1].lower())
        self.assertIn("disease", questions[0]["choices"][1].lower())
        self.assertIn("catastrophic", questions[1]["choices"][1].lower())
        self.assertIn("some wild groups", questions[1]["choices"][1].lower())
        self.assertIn("percents", questions[1]["choices"][1].lower())
        self.assertIn("SIV", questions[2]["choices"][1])
        self.assertIn("HIV-1", questions[2]["choices"][1])
        self.assertIn("lineages", questions[2]["choices"][1].lower())
        self.assertIn("2012", questions[3]["stem"])
        self.assertIn("closer to human", questions[3]["choices"][1].lower())
        self.assertIn("chimpanzee", questions[3]["choices"][1].lower())
        self.assertIn("percents", questions[3]["choices"][1].lower())
        self.assertIn("G. g. gorilla", questions[4]["choices"][1])
        self.assertIn("G. g. diehli", questions[4]["choices"][1])
        self.assertIn("Cross River", questions[4]["choices"][1])
        self.assertIn("SLC45A2", questions[5]["choices"][1])
        self.assertIn("carrier", questions[5]["choices"][1].lower())
        self.assertIn("inbreeding", questions[5]["choices"][1].lower())
        self.assertIn("modify sticks", questions[6]["choices"][1].lower())
        self.assertIn("holes", questions[6]["choices"][1].lower())
        self.assertIn("water depth", questions[6]["choices"][1].lower())
        self.assertIn("nominate", questions[7]["choices"][1].lower())
        self.assertIn("western gorilla", questions[7]["choices"][1].lower())
        self.assertIn("deeper", questions[8]["choices"][1].lower())
        self.assertIn("bushmeat", questions[8]["choices"][1].lower())
        self.assertIn("Congo swamp", questions[9]["choices"][1])
        self.assertIn("shelter", questions[9]["choices"][1].lower())
        self.assertIn("major populations", questions[9]["choices"][1].lower())
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertIn("Equus quagga", zebra_zoo["questions"][0]["choices"][1])
        ...
        self.assertIn("Hipposudoric acids", hippo_zoo["questions"][0]["choices"][1])
        ...
        self.assertIn("sondaica", tiger_zoo["questions"][0]["choices"][1])
