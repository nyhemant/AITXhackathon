...
class WhaleSharkHardStudyCardTests(unittest.TestCase):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(ray_hard["talk_about"], visible_prompts(TALK_ABOUT_STINGRAY, ray_hard["level"]))
        self.assertEqual(ray_hard["push_further"], visible_prompts(PUSH_FURTHER_STINGRAY, ray_hard["level"]))
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertIn("zoologist", payload["whale-shark"]["levels"])
        self.assertEqual(payload["whale-shark"]["levels"]["zoologist"]["teach"], [])
        ...
        self.assertIn("5 questions", hard_html)
        self.assertIn("data-pending", hard_html)
