...
class ChimpanzeeHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_CHIMPANZEE, "hard") + visible_prompts(PUSH_FURTHER_CHIMPANZEE, "hard"):
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertIn("zoologist", payload["chimpanzee"]["levels"])
        self.assertEqual(payload["chimpanzee"]["levels"]["zoologist"]["teach"], [])
