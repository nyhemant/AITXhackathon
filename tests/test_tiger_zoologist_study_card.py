...
class TigerZoologistStudyCardTests(unittest.TestCase):
    ...
    def test_zoologist_slots_and_copy_are_locked(self):
        ...
        self.assertIn("sondaica", questions[0]["choices"][1])
        self.assertIn("sumatrae", questions[0]["choices"][1])
        ...
        self.assertIn("Critically Endangered", questions[1]["choices"][1])
        self.assertIn("snapshot", questions[1]["choices"][1].lower() + questions[1]["why"].lower())
        self.assertIn("hundreds", questions[2]["choices"][1].lower())
        self.assertIn("fragmented", questions[2]["choices"][1].lower())
        self.assertIn("oil palm", questions[3]["choices"][1].lower())
        self.assertIn("acacia", questions[3]["choices"][1].lower())
        self.assertIn("Ice Age", questions[4]["choices"][1])
        self.assertIn("approximate", questions[4]["choices"][1].lower())
        self.assertIn("land bridge", questions[4]["why"].lower())
        self.assertIn("mtdna", questions[5]["choices"][1].lower())
        self.assertIn("microsatellite", questions[5]["choices"][1].lower())
        self.assertIn("mainland", questions[5]["choices"][1].lower())
        self.assertIn("studbook", questions[6]["choices"][1].lower())
        self.assertIn("founders", questions[6]["choices"][1].lower())
        self.assertIn("vestibular", questions[6]["choices"][1].lower())
        self.assertIn("CITES Appendix I", questions[7]["choices"][1])
        self.assertIn("tightly controlled", questions[7]["choices"][1].lower())
        self.assertIn("wire snares", questions[8]["choices"][1].lower())
        self.assertIn("accident", questions[8]["choices"][1].lower())
        self.assertIn("farms", questions[9]["choices"][1].lower())
        self.assertIn("settlements", questions[9]["choices"][1].lower())
