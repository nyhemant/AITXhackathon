...
class StarfishEasyStudyCardTests(unittest.TestCase):
    def test_deck_is_junior_ranger_only(self):
        ...
        self.assertEqual(deck["talk_about"], visible_prompts(TALK_ABOUT_STARFISH, deck["level"]))
        self.assertEqual(deck["push_further"], visible_prompts(PUSH_FURTHER_STARFISH, deck["level"]))
    ...
    def test_other_study_decks_untouched(self):
        ...
        self.assertEqual(turtle["talk_about"], visible_prompts(TALK_ABOUT_SEA_TURTLE, turtle["level"]))
        self.assertEqual(turtle["push_further"], visible_prompts(PUSH_FURTHER_SEA_TURTLE, turtle["level"]))
        ...
        self.assertEqual(octo["talk_about"], visible_prompts(TALK_ABOUT_OCTOPUS, octo["level"]))
        self.assertEqual(octo["push_further"], visible_prompts(PUSH_FURTHER_OCTOPUS, octo["level"]))
        ...
        self.assertEqual(kelp["talk_about"], visible_prompts(TALK_ABOUT_KELP_FOREST, kelp["level"]))
        self.assertEqual(kelp["push_further"], visible_prompts(PUSH_FURTHER_KELP_FOREST, kelp["level"]))
    ...
    def test_generator_html_is_study_not_worksheet(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_STARFISH, "easy") + visible_prompts(PUSH_FURTHER_STARFISH, "easy"):
