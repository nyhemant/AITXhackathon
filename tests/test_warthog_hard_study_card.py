...
class WarthogHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_slots_and_copy_are_locked(self):
        ...
        self.assertNotIn("(soft)", questions[4]["why"].lower())
    ...
    def test_hard_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_WARTHOG, "hard") + visible_prompts(PUSH_FURTHER_WARTHOG, "hard"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(panda_hard["talk_about"], visible_prompts(TALK_ABOUT_RED_PANDA, panda_hard["level"]))
        self.assertEqual(panda_hard["push_further"], visible_prompts(PUSH_FURTHER_RED_PANDA, panda_hard["level"]))
        ...
        self.assertEqual(koala_hard["talk_about"], visible_prompts(TALK_ABOUT_KOALA, koala_hard["level"]))
        self.assertEqual(koala_hard["push_further"], visible_prompts(PUSH_FURTHER_KOALA, koala_hard["level"]))
        ...
        self.assertEqual(chimp_hard["talk_about"], visible_prompts(TALK_ABOUT_CHIMPANZEE, chimp_hard["level"]))
        self.assertEqual(chimp_hard["push_further"], visible_prompts(PUSH_FURTHER_CHIMPANZEE, chimp_hard["level"]))
        ...
        self.assertEqual(orang_hard["talk_about"], visible_prompts(TALK_ABOUT_ORANGUTAN, orang_hard["level"]))
        self.assertEqual(orang_hard["push_further"], visible_prompts(PUSH_FURTHER_ORANGUTAN, orang_hard["level"]))
        ...
        self.assertEqual(giant_hard["talk_about"], visible_prompts(TALK_ABOUT_GIANT_PANDA, giant_hard["level"]))
        self.assertEqual(giant_hard["push_further"], visible_prompts(PUSH_FURTHER_GIANT_PANDA, giant_hard["level"]))
        ...
        self.assertEqual(lemur_hard["talk_about"], visible_prompts(TALK_ABOUT_RING_TAILED_LEMUR, lemur_hard["level"]))
        self.assertEqual(lemur_hard["push_further"], visible_prompts(PUSH_FURTHER_RING_TAILED_LEMUR, lemur_hard["level"]))
        ...
        self.assertEqual(ostrich_hard["talk_about"], visible_prompts(TALK_ABOUT_OSTRICH, ostrich_hard["level"]))
        self.assertEqual(ostrich_hard["push_further"], visible_prompts(PUSH_FURTHER_OSTRICH, ostrich_hard["level"]))
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        self.assertIn("#habitat=warthog", html)
