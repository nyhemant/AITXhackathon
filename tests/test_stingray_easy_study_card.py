"""Stingray Easy study-card: Junior Ranger teach + 10 MCQs (Park Ranger is a sibling level)."""
...
class StingrayEasyStudyCardTests(unittest.TestCase):
    ...
    def test_other_study_decks_untouched(self):
        ...
        self.assertEqual(horse["talk_about"], visible_prompts(TALK_ABOUT_SEAHORSE, horse["level"]))
        self.assertEqual(horse["push_further"], visible_prompts(PUSH_FURTHER_SEAHORSE, horse["level"]))
    ...
    def test_generator_html_is_study_not_worksheet(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_STINGRAY, "easy") + visible_prompts(PUSH_FURTHER_STINGRAY, "easy"):
    ...
    def test_other_animal_stays_generic_worksheet(self):
        ...
        self.assertIn("card-study-pack", star)
        self.assertNotIn("What do they eat?", star)
    ...
    def test_artifacts_include_stingray_easy_and_hard(self):
        ...
        self.assertEqual(set(ray["levels"]), {"easy", "hard", "zoologist"})
        self.assertEqual(ray["levels"]["zoologist"]["teach"], [])
        self.assertEqual(ray["levels"]["hard"]["teach"], [])
