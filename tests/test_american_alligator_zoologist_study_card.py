...
class AmericanAlligatorZoologistStudyCardTests(unittest.TestCase):
    ...
    def test_zoologist_print_is_answer_light_duplex(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_AMERICAN_ALLIGATOR, "zoologist") + visible_prompts(PUSH_FURTHER_AMERICAN_ALLIGATOR, "zoologist"):
    ...
    def test_other_animal_decks_untouched(self):
        ...
        self.assertEqual(otter_zoo["talk_about"], visible_prompts(TALK_ABOUT_SEA_OTTER, otter_zoo["level"]))
        self.assertEqual(otter_zoo["push_further"], visible_prompts(PUSH_FURTHER_SEA_OTTER, otter_zoo["level"]))
    ...
    def test_published_artifacts_and_plumbing(self):
        ...
        print_tpl = study_print_html_for("american-alligator")
