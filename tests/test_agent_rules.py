...
class WebApiScenarioTest(unittest.TestCase):
    ...
    def test_web_page_exposes_dinner_only_public_alpha(self):
        ...
        self.assertIn("Tell me the messy real-life version", HTML)
        ...
        self.assertIn("Time, energy, leftovers, fridge/pantry basics, picky kids, avoidances — messy is fine.", HTML)
