...
class WebApiScenarioTest(unittest.TestCase):
    ...
    def test_web_page_exposes_dinner_only_public_alpha(self):
        ...
        self.assertIn('<span class="input-helper-lead">Use prompts or share.</span>', HTML)
        self.assertIn('<span class="input-helper-detail">2–4 things on hand, mood to cook, fast or flexible, picky-kid no-gos, etc.</span>', HTML)
        ...
        self.assertIn("Say what failed — too much cleanup, missing ingredient, picky kid, or no energy.", HTML)
