...
class WebApiScenarioTest(unittest.TestCase):
    ...
    def test_web_page_exposes_dinner_only_public_alpha(self):
        ...
        self.assertIn("Dinner first, because that’s when the day gets loud.", HTML)
        ...
        self.assertIn('placeholder="Tortillas, eggs, picky 6-year-old, 20 min, low cleanup mood"', HTML)
