...
class WebApiScenarioTest(unittest.TestCase):
    ...
    def test_web_page_exposes_dinner_only_public_alpha(self):
        ...
        self.assertIn("Tell 1Less what’s in the fridge, who’s eating, and what kind of night it is.", HTML)
        self.assertIn("not fifteen recipes", HTML)
        self.assertIn("It’s late, people are hungry, and you don’t need fifteen options.", HTML)
        self.assertIn('aria-describedby="inputHelper"', HTML)
        self.assertIn('class="input-helper" id="inputHelper"', HTML)
        self.assertIn('placeholder="Tortillas, eggs, picky 6-year-old, 20 min, low-cleanup night"', HTML)
        self.assertIn('<span class="input-helper-lead">Messy is fine — leftovers, no-gos, budget, and mood all help.</span>', HTML)
        ...
        self.assertIn('window.addEventListener("resize", () => updateInputCopy(inputCopyState));', HTML)
        self.assertIn("what’s in the fridge", HTML)
        ...
        self.assertIn("Dinner help for the late-day scramble.", HTML)
        ...
        self.assertIn('aria-label="Show examples"', HTML)
        self.assertIn(">Get one dinner idea</button>", HTML)
        self.assertIn('<span>Show</span><span>examples</span>', HTML)
        ...
        self.assertIn("Pick one and make it sound like tonight.", HTML)
        self.assertIn("It’s 5pm, everyone is hungry, I have 10 minutes and I’m not in the mood to cook. Make it picky-kid friendly.", HTML)
        self.assertIn("I have tortillas, cheese, black beans, rice, and apples. I have 15 minutes and no store run.", HTML)
        self.assertIn("Vegetarian tonight. I have rice, eggs, frozen peas, and 20 minutes. I’m okay cooking a little.", HTML)
        ...
        self.assertIn("I have a few options but I’m too tired to choose. We have eggs, toast, fruit, rice, and frozen vegetables. Pick one easy dinner.", HTML)
