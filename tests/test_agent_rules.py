...
class WebApiScenarioTest(unittest.TestCase):
    ...
    def test_web_page_exposes_dinner_only_public_alpha(self):
        ...
        self.assertIn('<span class="input-helper-lead">Messy is fine — leftovers, avoidances, budget, and energy all help.</span>', HTML)
        ...
        self.assertIn("Type one messy sentence below", HTML)
