...
class WebApiScenarioTest(unittest.TestCase):
    ...
    def test_web_page_exposes_dinner_only_public_alpha(self):
        ...
        self.assertIn('aria-controls="samplePromptPanel">Use a sample night</button>', HTML)
        self.assertIn('id="photoPromptToggle"', HTML)
        self.assertIn('aria-controls="photoPromptPanel">Use photo to fill prompt</button>', HTML)
