...
class WebApiScenarioTest(unittest.TestCase):
    ...
    def test_web_page_exposes_dinner_only_public_alpha(self):
        ...
        self.assertIn("share the real-life constraints", HTML)
        ...
        self.assertIn('placeholder="What do you have, and what does tonight need?"', HTML)
        self.assertIn('<span class="input-helper-lead">Pick a sample, edit it, or type one messy sentence.</span>', HTML)
        ...
        self.assertIn("fridge/pantry", HTML)
        ...
        self.assertIn("Let’s make dinner one less decision.", HTML)
        ...
        self.assertIn('aria-label="Sample prompts"', HTML)
        self.assertIn('<span>Sample</span><span>prompts</span>', HTML)
