...
class LionEasyStudyCardTests(unittest.TestCase):
    ...
    def test_published_lion_card_matches_easy_deck(self):
        ...
        self.assertIn("study-card.js?v=3", html)
        self.assertIn("study-card.css?v=3", html)
        self.assertIn("study-cards-data.js?v=3", html)
        self.assertIn('id="study-card-data"', html)
        self.assertIn('"level_label": "Junior Ranger"', html)
        self.assertIn('id="study-print-template"', html)
        self.assertIn("print-kit.js?v=18", html)
        visible = _text(main)
        self.assertIn("Junior Ranger", visible)
        self.assertIn("Park Ranger", visible)
