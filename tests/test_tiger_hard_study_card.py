...
class TigerHardStudyCardTests(unittest.TestCase):
    ...
    def test_hard_slots_and_copy_are_locked(self):
        ...
        self.assertIn("understory cover", questions[0]["choices"][1])
        self.assertIn("more exposed", questions[0]["choices"][1])
        self.assertIn("uncultivated forest", questions[1]["choices"][1])
        self.assertIn("little use of plantations", questions[1]["choices"][1])
        self.assertIn("mid-sized forest mammals", questions[2]["choices"][1])
        self.assertIn("scattered habitat patches", questions[3]["choices"][1])
        self.assertIn("Habitat loss", questions[4]["choices"][1])
        self.assertIn("snares", questions[4]["choices"][1])
        self.assertIn("coastal lowland", questions[5]["choices"][1])
        self.assertIn("high mountain forest", questions[5]["choices"][1])
        self.assertIn("ambush", questions[6]["choices"][1])
        self.assertIn("long open chase", questions[6]["choices"][1])
        self.assertIn("Large connected forest", questions[7]["choices"][1])
        self.assertIn("edges", questions[7]["choices"][1])
        self.assertIn("dissolve into spots", questions[8]["choices"][1])
        self.assertIn("small dark spots", questions[8]["choices"][1])
        self.assertIn("major national parks", questions[9]["choices"][1])
