...
class HippoEasyStudyCardTests(unittest.TestCase):
    ...
    def test_generator_html_is_study_not_worksheet(self):
        ...
        for prompt in visible_prompts(TALK_ABOUT_HIPPO, "easy") + visible_prompts(PUSH_FURTHER_HIPPO, "easy"):
        ...
        self.assertIn("Facts from Wikipedia, Hippopotamus. Where sources disagree on exact numbers, we keep them approximate.", html)
    ...
    def test_published_hippo_card_matches_easy_deck(self):
        ...
        self.assertIn("/field-pack/virtual-field-trip/?tab=zoo&from=card#habitat=nile-hippo", main.replace("&amp;", "&"))
        ...
        self.assertIn('aria-label="View larger photo: Nile hippo"', main)
