...
## Landing
- Live home stays `/` → `/field-pack/` (map hub). First-time alternate is `/start/` — full-bleed giraffe hero + headline, then trust, three doors, and proof. Do not replace the home.
