...
## Landing
- Live home stays `/` → `/field-pack/` (map hub). First-time alternate is `/start/` — giraffe hero, then large elephant and lion stills, then cream rest / home / going / teaching chapters, then trust, three doors, and proof. Do not replace the home.
